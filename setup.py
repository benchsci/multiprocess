...
from version import __contact__ as AUTHOR_EMAIL
from version import __version__, get_license_text, get_readme_as_rst, write_info_file
...
try:
    ...
    from distutils.core import Extension, setup  # noqa
...
if sys.platform == "win32":  # Windows
    ...
    macros = dict(  # FreeBSD 7+ and GNU/kFreeBSD 8+
        HAVE_SEM_OPEN=bool(
            ...
            and not bool(sysconfig.get_config_var("POSIX_SEMAPHORES_NOT_ENABLED"))
        ),
        HAVE_SEM_TIMEDWAIT=1,
        HAVE_FD_TRANSFER=1,
    )
